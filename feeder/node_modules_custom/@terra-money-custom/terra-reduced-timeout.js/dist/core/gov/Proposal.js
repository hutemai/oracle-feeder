...
var Proposal = /** @class */ (function (_super) {
    ...
    Proposal.fromData = function (data) {
        ...
        return new Proposal(Number.parseInt(proposal_id), Proposal.Content.fromData(content), gov_1.proposalStatusFromJSON(status), {
    ...
    Proposal.prototype.toData = function () {
        ...
        return {
            ...
            status: gov_1.proposalStatusToJSON(status),
            final_tally_result: {
