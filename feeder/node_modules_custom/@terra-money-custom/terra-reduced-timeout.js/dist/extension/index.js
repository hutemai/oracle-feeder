...
var Extension = /** @class */ (function () {
    ...
    Extension.prototype.post = function (options) {
        ...
        return this.send('post', {
            msgs: options.msgs.map(function (msg) { return any_1.Any.toJSON(msg.packAny()); }),
            fee: options.fee ? tx_1.Fee.toJSON((_a = options.fee) === null || _a === void 0 ? void 0 : _a.toProto()) : undefined,
            memo: options.memo,
