...
function isTxError(x) {
    return x.code !== undefined && x.code !== 0;
}
...
var TxAPI = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(!accountNumber || !sequence)) return [3 /*break*/, 2];
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.lcd.tx.estimateFee(msgs, options)];
                    case 3:
                        fee = _a.sent();
                        _a.label = 4;
                    case 4: return [2 /*return*/, new core_1.Tx(new core_1.TxBody(msgs, memo || '', options.timeoutHeight || 0), new core_1.AuthInfo([], fee), [])];
                }
            });
        });
    };
     ...
     */
    TxAPI.prototype.estimateFee = function (msgs, options) {
        return __awaiter(this, void 0, void 0, function () {
            var memo, gas, gasPrices, gasAdjustment, feeDenoms, gasPricesCoins, gasPricesCoinsFiltered, signerInfo, txBody, authInfo, tx, simulateRes, taxAmount, feeAmount;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        signerInfo = new core_1.SignerInfo(new core_1.SimplePublicKey(''), (options === null || options === void 0 ? void 0 : options.sequence) || 0, new core_1.ModeInfo(new core_1.ModeInfo.Single((options === null || options === void 0 ? void 0 : options.signMode) || core_1.ModeInfo.SignMode.SIGN_MODE_DIRECT)));
                        txBody = new core_1.TxBody(msgs, memo || '', 0);
                        authInfo = new core_1.AuthInfo([signerInfo], new core_1.Fee(0, new core_1.Coins(), '', ''));
                    ...
                    case 1:
                        simulateRes = _a.sent();
                        gas = new core_1.Dec(gasAdjustment)
                            .mul(simulateRes.gas_info.gas_used)
                            .toString();
                        _a.label = 2;
                    case 2: return [4 /*yield*/, this.c
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        txBytes = _a.sent();
                        return [2 /*return*/, hash_1.hashAmino(txBytes)];
                }
            });
        });
    };
