...
var Key = /** @class */ (function () {
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        ...
                        _b = [void 0, new core_1.SimplePublicKey(this.publicKey.toString('base64'))];
    ...
    Key.prototype.createSignature = function (tx) {
        return __awaiter(this, void 0, void 0, function () {
            var publicKey, modified, sigBytes;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        publicKey = new core_1.SimplePublicKey(this.publicKey.toString('base64'));
                        modified = tx.auth_info.signer_infos.length === 0;
                        if (modified) {
                            tx.auth_info.signer_infos.push(new core_1.SignerInfo(publicKey, tx.sequence, new core_1.ModeInfo(new core_1.ModeInfo.Single(signing_1.SignMode.SIGN_MODE_DIRECT))));
                        }
                        return [4 /*yield*/, this.sign(Buffer.from(tx.toBytes()))];
                    case 1:
                        ...
                        return [2 /*return*/, new SignatureV2_1.SignatureV2(publicKey, new SignatureV2_1.SignatureV2.Descriptor(new SignatureV2_1.SignatureV2.Descriptor.Single(signing_1.SignMode.SIGN_MODE_DIRECT, sigBytes)), tx.sequence)];
                }
            });
        });
    };
    ...
    Key.prototype.signTx = function (tx, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        copyTx = core_1.Tx.fromData(tx.toData());
                    ...
                    case 4:
                        ...
                        copyTx.auth_info.signer_infos.push(new core_1.SignerInfo(signature.public_key, signature.sequence, new core_1.ModeInfo(new core_1.ModeInfo.Single(sigData.mode))));
